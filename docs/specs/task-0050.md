...
describe("AuthenticatedUser", () => {
  ...
  describe("activity tracking", () => {
    it("should update last activity timestamp", () => {
      ...
      expect(user.lastActivityAt.getTime()).toBeGreaterThan(
...
import { AuthenticatedUserFactory } from "../../factories/authenticated-user.factory";
import { UserAuthenticatedSuccessfully, AuthenticationFailed } from "../../events/authentication.events";
...
describe("AuthenticationAggregate", () => {
  ...
  describe("authenticate", () => {
    ...
    it("should emit AuthenticationFailed event on error", async () => {
      ...
      await expect(aggregate.authenticate(supabaseUserData))
  ...
  describe("logout", () => {
    it("should logout authenticated user", async () => {
      ...
      expect(mockRepository.updateLastActivity).toHaveBeenCalledWith(
        user.id,
        expect.any(Date)
      );
    });
    ...
    it("should throw error when logging out non-authenticated user", async () => {
      ...
      await expect(aggregate.logout(userId))
