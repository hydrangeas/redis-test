...
export const DashboardPage: React.FC = () => {
  ...
  const { stats, loading: statsLoading, error: statsError } = useApiStats({
    timeRange: "7d",
  });
              ...
              <CardContent className="flex items-center justify-between p-6">
                <div className="flex-1">
                  ...
                  <div className="mt-1 text-sm text-gray-500 space-y-1">
                    ...
                    <p>
                      作成日: {formatDistanceToNow(key.createdAt, { 
                        addSuffix: true,
                        locale: ja,
                      })}
                    </p>
                    {key.lastUsedAt && (
                      <p>
                        最終使用: {formatDistanceToNow(key.lastUsedAt, {
                          addSuffix: true,
                          locale: ja,
                        })}
                      </p>
