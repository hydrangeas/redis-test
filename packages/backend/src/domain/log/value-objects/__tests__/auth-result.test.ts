...
describe('AuthResult', () => {
  describe('enum values', () => {
    it('should have correct enum values', () => {
      ...
      expect(AuthResult.FAILURE).toBe('FAILURE');
...
describe('AuthResultHelper', () => {
  describe('fromString', () => {
    it('should convert valid strings to AuthResult', () => {
      ...
      expect(AuthResultHelper.fromString('FAILURE')).toBe(AuthResult.FAILURE);
  ...
  describe('isSuccess', () => {
    it('should identify success result', () => {
      ...
      expect(AuthResultHelper.isSuccess(AuthResult.FAILURE)).toBe(false);
  ...
  describe('isFailure', () => {
    it('should identify failure results', () => {
      ...
      expect(AuthResultHelper.isFailure(AuthResult.FAILURE)).toBe(true);
