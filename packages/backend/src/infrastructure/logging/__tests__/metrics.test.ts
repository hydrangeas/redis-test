...
describe('Performance Metrics', () => {
  ...
  describe('measurePerformance', () => {
    it('should measure and log async operation performance', async () => {
      ...
      const result = await measurePerformance(mockLogger, 'async-operation', mockOperation, {
        requestId: 'req-123',
      });
    ...
    it('should measure performance with delay', async () => {
      ...
      const result = await measurePerformance(mockLogger, 'delayed-operation', mockOperation);
  ...
  describe('measureSyncPerformance', () => {
    it('should measure and log sync operation performance', () => {
      ...
      const result = measureSyncPerformance(mockLogger, 'sync-operation', mockOperation, {
        userId: 'user-456',
      });
