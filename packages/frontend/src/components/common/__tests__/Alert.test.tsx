...
describe('Alert', () => {
  ...
  it('should not render close button when onClose is not provided', () => {
    render(
      <Alert type="info">Alert without close button</Alert>
    );
  ...
  it('should render complex children content', () => {
    ...
    expect(screen.getByText(/This is a complex message with/)).toBeInTheDocument();
    expect(screen.getByRole('link', { name: 'a link' })).toBeInTheDocument();
  });

  it('should have proper ARIA role', () => {
    render(
      <Alert type="error">Accessible alert</Alert>
    );
  ...
  it('should have alert-content wrapper', () => {
    const { container } = render(
      <Alert type="info">Alert content</Alert>
    );
