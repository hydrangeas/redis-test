  ...
  render: () => (
    <div className="space-y-4 w-96">
      ...
      <Card padding="md">
        ...
        <CardDescription>This card has medium padding (default)</CardDescription>
      </Card>
      <Card padding="lg">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-purple-100 dark:bg-purple-900 rounded-full flex items-center justify-center">
                <span className="text-purple-600 dark:text-purple-400 font-semibold">UI</span>
              </div>
              <div>
            ...
            <div className="pt-4">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-gray-900 dark:text-gray-100 font-medium">75%</span>
              </div>
