...
const Alert = forwardRef<HTMLDivElement, AlertProps>(
  ({ className, variant = 'default', icon, onClose, children, ...props }, ref) => {
    ...
    const variants = {
      ...
      success: 'bg-green-50 text-green-900 dark:bg-green-900/20 dark:text-green-400 border border-green-200 dark:border-green-800',
      warning: 'bg-yellow-50 text-yellow-900 dark:bg-yellow-900/20 dark:text-yellow-400 border border-yellow-200 dark:border-yellow-800',
      error: 'bg-red-50 text-red-900 dark:bg-red-900/20 dark:text-red-400 border border-red-200 dark:border-red-800',
    };
