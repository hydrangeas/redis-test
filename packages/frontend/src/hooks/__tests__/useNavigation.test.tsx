...
describe('useNavigation', () => {
  ...
  it('should navigate to a path', () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith('/new-path', { replace: false, state: undefined });
  });
  ...
  it('should navigate with replace option', () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith('/new-path', { replace: true, state: undefined });
  });
  ...
  it('should navigate with state', () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith('/new-path', { replace: false, state });
  });
  ...
  it('should preserve query parameters when requested', () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith('/new-path?query=value', { replace: false, state: undefined });
  });
