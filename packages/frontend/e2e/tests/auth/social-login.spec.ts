...
test.describe("Social Login Flow", () => {
  ...
  test("should display social login options on landing page", async ({
    page,
  }) => {
    // Check landing page
    ...
    await expect(
      page
        .locator('button:has-text("googleg����")')
        .or(page.locator('button:has-text("Sign in with Google")'))
    ).toBeVisible();
    await expect(
      page
        .locator('button:has-text("githubg����")')
        .or(page.locator('button:has-text("Sign in with GitHub")'))
    ).toBeVisible();
  });
  ...
  test("should persist login state across page refresh", async ({
    page,
    context,
  }) => {
